...
const starterResources = [
  {
    ...
    summary:
      "Guides and demos focused on modern WordPress development, front-end tooling, and practical implementation.",
    type: "Tutorials & demos",
  },
  {
    title: "Workshop materials",
    summary:
      "Structured learning activities, exercises, and reference materials for developers and learners.",
    type: "Workshops",
  },
  {
    title: "Teaching and CPD resources",
    summary:
      "Classroom-tested resources and professional development materials shaped by education and mentoring experience.",
    type: "Education",
  },
];
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-20 sm:py-24">
      ...
      <section className="mt-12 rounded-xl border border-border bg-secondary/30 p-6">
        ...
        <a
          href="mailto:mjbertram87@gmail.com"
