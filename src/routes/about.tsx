    ...
    <div className="mx-auto w-full max-w-4xl px-6 py-20 sm:py-24">
      <header className="mb-12">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-md border border-border bg-secondary/40 px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-secondary"
        >
      ...
      <section className="mb-16">
        ...
        <ol className="mt-6 space-y-6 border-l border-border">
          {timeline.map((item) => (
            <li key={item.role + item.company} className="relative pl-6">
